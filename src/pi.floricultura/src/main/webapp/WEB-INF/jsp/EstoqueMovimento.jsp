<%-- 
    Document   : EstoqueMovimento
    Created on : 21/05/2018, 18:24:14
    Author     : aayan
--%>
        ...
        <div id="wrapper">
            ...
            <div id="main">
                <div class="inner">
                    ...
                    <!-- Content -->
                    <section>
                        <form id="relatorio-form" action="${pageContext.request.contextPath}/movimentoestoque" method="post">
                            ...
                            <c:forEach items = "${listaMovimento}" var = "movimento">
                                <tr>
                                    <td><c:out value="${movimento.codigo}"/></td>
